...
def build_dr_head(
    ...
    x = layers.Dense(num_classes, use_bias=True, activation="softmax", name="dr_output")(x)
    return x
...
def build_dme_head(
    ...
    if residual_mlp:
        ...
        h = layers.Dense(hidden_units, use_bias=True, name="dme_fc1")(x)
        h = layers.Activation("swish", name="dme_fc1_act")(h)
        h = layers.Dropout(dropout_rate * 0.5, name="dme_fc1_dropout")(h)
        h = layers.Dense(hidden_units, use_bias=True, name="dme_fc2")(h)
        ...
        x = layers.Dense(hidden_units, use_bias=True, activation="relu", name="dme_fc1")(x)
        x = layers.Dropout(dropout_rate, name="dme_dropout")(x)
    x = layers.Dense(num_classes, use_bias=True, activation="softmax", name="dme_risk")(x)
    return x
